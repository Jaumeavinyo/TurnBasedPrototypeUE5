...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_TurnBasedPrototype_OnInteractionSelected__DelegateSignature_Statics::NewProp_InteractionType = { "InteractionType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_TurnBasedPrototype_eventOnInteractionSelected_Parms, InteractionType), Z_Construct_UEnum_TurnBasedPrototype_EInteractionType, METADATA_PARAMS(0, nullptr) }; // 821326794
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UInteractionMenuItemWidget_ConfigureInteraction_Statics::NewProp_interactionType = { "interactionType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InteractionMenuItemWidget_eventConfigureInteraction_Parms, interactionType), Z_Construct_UEnum_TurnBasedPrototype_EInteractionType, METADATA_PARAMS(0, nullptr) }; // 821326794
...
struct Z_Construct_UClass_UInteractionMenuItemWidget_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UInteractionMenuItemWidget_ConfigureInteraction, "ConfigureInteraction" }, // 2612317023
...
struct Z_CompiledInDeferFile_FID_Users_jauma_Documents_GitHub_TurnBasedPrototypeUE5_TurnBasedPrototype_Source_TurnBasedPrototype_Public_UI_InteractionMenuItemWidget_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInteractionMenuItemWidget, UInteractionMenuItemWidget::StaticClass, TEXT("UInteractionMenuItemWidget"), &Z_Registration_Info_UClass_UInteractionMenuItemWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInteractionMenuItemWidget), 4050193085U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jauma_Documents_GitHub_TurnBasedPrototypeUE5_TurnBasedPrototype_Source_TurnBasedPrototype_Public_UI_InteractionMenuItemWidget_h_1786463517(TEXT("/Script/TurnBasedPrototype"),
