...
// Begin Class ADoor Function StartRotation
struct Door_eventStartRotation_Parms
{
	bool bToOpen;
};
static const FName NAME_ADoor_StartRotation = FName(TEXT("StartRotation"));
void ADoor::StartRotation(bool bToOpen)
{
	Door_eventStartRotation_Parms Parms;
	Parms.bToOpen=bToOpen ? true : false;
	UFunction* Func = FindFunctionChecked(NAME_ADoor_StartRotation);
	ProcessEvent(Func,&Parms);
}
struct Z_Construct_UFunction_ADoor_StartRotation_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Door.h" },
...
#endif // WITH_METADATA
	static void NewProp_bToOpen_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bToOpen;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
void Z_Construct_UFunction_ADoor_StartRotation_Statics::NewProp_bToOpen_SetBit(void* Obj)
{
	((Door_eventStartRotation_Parms*)Obj)->bToOpen = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ADoor_StartRotation_Statics::NewProp_bToOpen = { "bToOpen", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(Door_eventStartRotation_Parms), &Z_Construct_UFunction_ADoor_StartRotation_Statics::NewProp_bToOpen_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ADoor_StartRotation_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ADoor_StartRotation_Statics::NewProp_bToOpen,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ADoor_StartRotation_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ADoor_StartRotation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ADoor, nullptr, "StartRotation", nullptr, nullptr, Z_Construct_UFunction_ADoor_StartRotation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ADoor_StartRotation_Statics::PropPointers), sizeof(Door_eventStartRotation_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ADoor_StartRotation_Statics::Function_MetaDataParams), Z_Construct_UFunction_ADoor_StartRotation_Statics::Function_MetaDataParams) };
static_assert(sizeof(Door_eventStartRotation_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ADoor_StartRotation()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ADoor_StartRotation_Statics::FuncParams);
	}
	return ReturnFunction;
}
// End Class ADoor Function StartRotation
...
struct Z_Construct_UClass_ADoor_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ADoor_StartRotation, "StartRotation" }, // 1251864482
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ADoor_Statics::NewProp_DoorMeshComponent = { "DoorMeshComponent", nullptr, (EPropertyFlags)0x001000000008000c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ADoor, DoorMeshComponent), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DoorMeshComponent_MetaData), NewProp_DoorMeshComponent_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_jauma_Documents_GitHub_TurnBasedPrototypeUE5_TurnBasedPrototype_Source_TurnBasedPrototype_Public_Door_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ADoor, ADoor::StaticClass, TEXT("ADoor"), &Z_Registration_Info_UClass_ADoor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADoor), 486003685U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jauma_Documents_GitHub_TurnBasedPrototypeUE5_TurnBasedPrototype_Source_TurnBasedPrototype_Public_Door_h_2349412414(TEXT("/Script/TurnBasedPrototype"),
